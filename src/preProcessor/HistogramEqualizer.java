...
public class HistogramEqualizer extends ImageProcessor{
	...
	protected void initializedPreOperation() {
		imageFileName = "HQ_Image_" + imageFileName;
	}

	public File getHistogramEqualizedImage(File imageFile, Map<Integer, Long> grayScaleFrequency) {
		...
		for(int i = 0; i <= 255; i++) {
			int newValue = (int) Math.ceil(255 * grayScaleCF.get(i) / totalNumberOfPixel);
